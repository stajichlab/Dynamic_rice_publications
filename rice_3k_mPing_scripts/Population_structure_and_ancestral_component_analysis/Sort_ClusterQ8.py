...
def main():
    ...
    for i in range(len(strains)):
        ...
        if c_index == 1:
            #Basmati/sadri
            meta[s] = [popn[2], pop[2], c[c_index], c[0]]
        elif c_index == 3:
            #Temperate japonica
            meta[s] = [popn[3], pop[3], c[c_index], c[2]]
        elif c_index == 2:
            #Tropical japonica
            meta[s] = [popn[4], pop[4], c[c_index], c[3]]
        elif c_index == 0:
            #Indica
            meta[s] = [popn[0], pop[0], c[c_index], c[4]]
        elif c_index == 4:
            #Aus/boro
            meta[s] = [popn[1], pop[1], c[c_index], c[0]]
