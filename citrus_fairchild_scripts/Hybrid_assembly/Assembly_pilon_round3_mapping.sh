...
#SBATCH --mem=100G
#SBATCH --time=5:00:00
#SBATCH --output=run_speedseq_falconv3_20kb_contig_graph_raw.named.sh.stdout
#SBATCH -p intel
#SBATCH --workdir=./
...
genome=/rhome/cjinfeng/BigData/00.RD/Assembly/Pacbio/pilon/mapping/Fairchild_contig_graph.raw.named.fasta
